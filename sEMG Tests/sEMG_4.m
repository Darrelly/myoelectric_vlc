%% Collecting Data from Just 4 sEMG Sensors
...
% Frequency: 1.4553e+03, 1.8271e+03, 1.1873e+03, 1.6635e+03, 1.4050e+03
pause();
clc; clear; close all;
...
arduinoObj = serial('/dev/cu.usbmodem14401','BaudRate',115200);
fopen(arduinoObj);
...
for gest = 1:size(gestures,2)
    ...
    while toc < collection_time
        class_data = [class_data; fgets(arduinoObj)];        
        time_temp(ind) = toc;
        ind = ind + 1;
    end
...
% Save file
train_filename = nextname('sEMG_4_train_','01','.csv');
...
% Save file
test_filename = nextname('sEMG_4_test_','01','.csv');
writetable(testing_data_labeled,test_filename);


%% Import Table 1
train_filename = 'sEMG_4_train_01.csv'
...
test_filename = 'sEMG_4_test_01.csv'
...
cm.Title = 'Error Rates with 4 sEMG Sensors';

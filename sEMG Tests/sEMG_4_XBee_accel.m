...
% Freq: 191.2713, ___, 187.1133, 189.3284
clc; clear; close all;
...
training_table = array2table(training_data,...
    'VariableNames',{'sEMG1','sEMG2','sEMG3','sEMG4','x','y','z'});

training_table_labeled = addvars(training_table,training_labels);

% Save file
train_filename = nextname('sEMG_4_XBee_accel_train_','01','.csv');
...
% Save file
test_filename = nextname('sEMG_4_XBee_accel_test_','01','.csv');
writetable(testing_data_labeled,test_filename);


%% Import Table 1
train_filename = 'sEMG_4_XBee_accel_train_03.csv'
...
test_filename = 'sEMG_4_XBee_accel_test_03.csv'
...
cm.Title = 'Error Rates with 4 sEMG Sensors and 1 Accelerometer';
